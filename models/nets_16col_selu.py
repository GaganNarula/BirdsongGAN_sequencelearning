...
class _netG(nn.Module):
    def __init__(self, ngpu,nz,ngf,nc):
        ...
        self.nc = nc
        self.ngpu = ngpu
        self.convs = nn.ModuleList([nn.ConvTranspose2d(nz, ngf * 8, kernel_size=(3,3), 
                                    ...
                                    nn.ConvTranspose2d(ngf * 4, ngf * 2, kernel_size=(5, 4), stride=(4, 1),
                                                       padding=(1, 1), bias=False),
                                    nn.ConvTranspose2d(ngf * 2, ngf, kernel_size=(5, 4), stride=(2, 1), 
                                                       padding=(1, 0),bias=False),
                                    nn.ConvTranspose2d(ngf, nc, kernel_size=(5, 4), stride=(2, 2),
                                                       padding=(0,1),
                                                       bias=True)])
