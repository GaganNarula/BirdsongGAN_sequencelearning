...
def weights_init(m):
    ...
    elif (classname.find('InstanceNorm') != -1) and AFF:
...
class _netG(nn.Module):
    def __init__(self, ngpu,nz,ngf,nc):
        ...
        self.bn_fake = nn.ModuleList(
            [nn.InstanceNorm2d(ngf * 8, affine = AFF, track_running_stats = TRACK_STATS),
            nn.InstanceNorm2d(ngf * 4, affine = AFF, track_running_stats = TRACK_STATS),
            nn.InstanceNorm2d(ngf * 2, affine = AFF, track_running_stats = TRACK_STATS),
            nn.InstanceNorm2d(ngf, affine = AFF, track_running_stats = TRACK_STATS)])
...
class _netD(nn.Module):
    def __init__(self, ngpu,ndf,nc):
        ...
        self.bns = nn.ModuleList([
            nn.InstanceNorm2d(ndf * 2, affine = AFF, track_running_stats = TRACK_STATS),
            nn.InstanceNorm2d(ndf * 4, affine = AFF, track_running_stats = TRACK_STATS),
            nn.InstanceNorm2d(ndf * 8, affine = AFF, track_running_stats = TRACK_STATS)])
