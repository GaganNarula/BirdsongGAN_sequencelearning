...
def weights_init(m):
    ...
    elif (classname.find('BatchNorm') != -1) and AFF:
...
class _netD(nn.Module):
    def __init__(self, ngpu,ndf,nc):
        ...
        self.bns = nn.ModuleList([
            nn.BatchNorm2d(ndf * 2, affine = AFF, track_running_stats = TRACK_STATS),
            nn.BatchNorm2d(ndf * 4, affine = AFF, track_running_stats = TRACK_STATS),
            nn.BatchNorm2d(ndf * 8, affine = AFF, track_running_stats = TRACK_STATS)])
